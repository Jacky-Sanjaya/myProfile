				...
				<div className="about-2">
					...
					<div className="about-3">
						<p className="desc">
							...
							Infomatics Engineering . I always wanted to be a great developer ,
							and I will do anyting to chase that dream . Oh and also I am
							excellent in working as a group to achieve a certain objective
						</p>
						<Button
							name="VIEW RESUME"
							link="https://drive.google.com/file/d/1jTeV6FPr5sTjxzbLlwmxDkTP0UCpH9Au/view?usp=sharing"
